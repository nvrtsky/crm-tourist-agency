  ...
  async getAllLeads(userId?: string, userRole?: string): Promise<LeadWithTouristCount[]> {
    ...
    let query = db
      .select({
        ...
        selectedCities: leads.selectedCities,
        tourCost: leads.tourCost,
        tourCostCurrency: leads.tourCostCurrency,
        advancePayment: leads.advancePayment,
        advancePaymentCurrency: leads.advancePaymentCurrency,
        remainingPayment: leads.remainingPayment,
        remainingPaymentCurrency: leads.remainingPaymentCurrency,
        roomType: leads.roomType,
        hotelCategory: leads.hotelCategory,
        transfers: leads.transfers,
        meals: leads.meals,
        formId: leads.formId,
        color: leads.color,
        notes: leads.notes,
