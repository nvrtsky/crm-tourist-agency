...
function KanbanBoard({ leads, events, isLoading, onStatusChange, onEdit, onDelete, onConvert, getLeadName }: KanbanBoardProps) {
  ...
  const columns: { 
    ...
    { status: "qualified", label: "Квалифицирован", variant: "outline", customClass: "bg-orange-100 dark:bg-orange-950 text-orange-900 dark:text-orange-50 border-orange-300 dark:border-orange-800" },
