...
### Key Features
-   **Events Module**: Manages tourist events, offering filtering, sorting, participant tracking, and comprehensive editing capabilities. Includes inline editable itinerary details and Excel export. Participant counting specifically includes only "Подтвержден" (converted) leads. Events can be archived, copied, and deleted (admin only).
